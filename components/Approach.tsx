  ...
  return (
    <section className="w-full py-20">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4 ">
        ...
        desc="WE'll collaborate to map out your website's goals, target audience, and key functionalities"
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card title="Development & Progress Update" icon={<AceternityIcon order="Phase 2" />}desc="WE'll collaborate to map out your website's goals, target audience, and key functionalities">
          <CanvasRevealEffect
            animationSpeed={3}
...
const Card = ({
  ...
  return (
    ...
    >
      ...
      <div className="text-center  absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] group-hover:canvas-card:opacity-0 transition duration-200 w-full mx-auto flex items-center justify-center group-hover:opacity-0">
  {icon}
</div>
